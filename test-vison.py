...
def extract_text_from_image(image_path):
    ...
    # Chuyển đổi ảnh thành ảnh xám và áp dụng bộ lọc để cải thiện chất lượng
...
def interact_with_gemini(prompt, extracted_text, history=[]):
...
image_path = 'D:\\THUCTAP\\images\\6.png'
...
gemini_response = interact_with_gemini(prompt, extracted_text)
